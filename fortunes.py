...
"A gambler not only will lose what he has, but also what he doesn't have.",
...
"Don't be discouraged, every wrong attempt discarded is another step forward.",
...
"Better to be an optimist proven wrong than to be a pessimist proven right.",
...
"It's not the amount of time you devote, but what you devote to the time.",
...
"You are interested in higher education, material or spiritual.",
...
"You appreciate how important it is to share your personal beliefs.",
...
def fortune_gen():
    number = random.randint(0, len(fortunes) - 1)
    print(fortunes[number].lower())
    return fortunes[number].lower()
